  ...
  return (
    <form className='TodoForm d-flex align-items-center justify-content-space-around' onSubmit={handleSubmit}>
        <div className="form-floating mb-3 me-3" >
            <input type="text" className="form-control" id="floatingInput" value={value} onChange={(e) => setValue(e.target.value)} style={{color: '#5E1B89'}}/>
        ...
        <div className="form-floating mb-3 me-3">
            <input type="time" className="form-control" id="floatingInput" value={selectedTime} onChange={(e) => setSelectedTime(e.target.value)} style={{color: '#5E1B89'}} required/>
        </div>
